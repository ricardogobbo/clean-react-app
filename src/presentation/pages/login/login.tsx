  ...
  return (
    <div className={Styles.login}>
      <header className={Styles.header}>
        ...
        <h1>Clean React - Login</h1>
      </header>
      <Form className={Styles.form}>
        <Form.Group controlId="formBasicEmail">
          <Form.Label>Email address</Form.Label>
          <Form.Control type="email" placeholder="Enter email" className="is-invalid" />
          <Form.Text className="text-muted">Insert your email address.</Form.Text>
        </Form.Group>
      ...
      <footer className={Styles.footer}>&copy; 2020 - All Rights reserved.</footer>
    </div>
  )
}
